# シンプルマルチエージェント構成（社長・PM・マーケター・デザイナー・プログラマー・コードチェック）

**版:** v1.3  
**目的:**  
社長、PM、マーケター、デザイナー、プログラマー、コードチェックの6つのエージェントが協調してアプリ開発を進める。
...
| `agent-designer` | デザイナー | UI/UXデザイン・プロトタイプ作成・デザインシステム構築 | ✅ |
...
**保存先:** `/{ProjectName}/04_デザイン/`

---

### 2.5 プログラマー（agent-programmer）
...
3. PMがタスクを定義・割り当て（マーケターの要件を反映、社長の承認が必要な場合は承認を取得）
   ↓
4. デザイナーがUI/UXデザインを作成（マーケターの要件を反映）
   ↓
5. プログラマーがコードを実装（デザイナーのデザイン仕様に基づく）
   ↓
6. コードチェックがレビューを実施
   ↓
7. レビュー結果に基づいて：
   ...
   - NG → プログラマーに差し戻し（5に戻る）
   ↓
8. 重要なマイルストーンは社長に報告・承認
9. リリース時はマーケターがマーケティング戦略を実行
```
...
1. マーケターがユーザー要件を提供
   ↓
2. デザイナーがUI/UXデザインを作成
   ↓
3. PMがデザインをレビュー・承認
   ↓
4. プログラマーがデザイン仕様に基づいて実装
   ↓
5. コードチェックがデザイン実装を確認
```
...
2. PMが要件を反映してタスクを定義
   ↓
3. デザイナーがユーザー要件を反映してデザイン
   ↓
4. プログラマーがユーザー要件を考慮して実装
   ↓
5. リリース時にマーケターがマーケティング戦略を実行
```
...
ユーザー: 
@agent-designer ログイン機能のUI/UXデザインを作成してください。
マーケターから提供された要件を反映してください。
...
マーケターの要件とデザイナーのデザイン仕様を反映してください。
...
PMから割り当てられたタスク、マーケターの要件、デザイナーのデザイン仕様に基づいて実装してください。
